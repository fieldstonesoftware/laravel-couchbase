...
use Fieldstone\Couchbase\Relations\BelongsTo;
use Fieldstone\Couchbase\Relations\BelongsToMany;
use Fieldstone\Couchbase\Relations\HasMany;
use Fieldstone\Couchbase\Relations\HasOne;
use Fieldstone\Couchbase\Relations\MorphTo;
...
trait HybridRelations
{
    ...
    public function hasOne($related, $foreignKey = null, $localKey = null)
    {
        ...
        if (!is_subclass_of($related, 'Fieldstone\Couchbase\Eloquent\Model')) {
