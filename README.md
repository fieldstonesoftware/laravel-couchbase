...
This extension was forked from [ORT-Interactive-GmbH / laravel-couchbase](https://github.com/ORT-Interactive-GmbH/laravel-couchbase)
...
```php
$app->register(Fieldstone\Couchbase\CouchbaseServiceProvider::class);
...
{
    return new Fieldstone\Couchbase\Connection($config);
});
```
...
```php
'CouchbaseModel'       => 'Fieldstone\Couchbase\Eloquent\Model',
```
...
If you're using a hybrid Couchbase and SQL setup, you're in luck! The model will automatically return a Couchbase- or SQL-relation based on the type of the related model. Of course, if you want this functionality to work both ways, your SQL-models will need use the `Fieldstone\Couchbase\Eloquent\HybridRelations` trait. Note that this functionality only works for hasOne, hasMany and belongsTo relations.
